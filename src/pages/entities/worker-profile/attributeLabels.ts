/** Maps TEW worker Attribute ids (personality + general) to their display name. */
export const ATTR_MAP: Record<number, string> = {
...
/** Maps TEW worker personality Attribute ids to their tooltip description. */
export const ATTR_TOOLTIP: Record<number, string> = {
